...
<div class="container flex flex-col items-center row justify-center col-md-8 card">
  ...
  <div class="card-body">
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="firstName" type="text" class="form-control" name="firstName" value="{{ $user->firstName }}" autofocus readonly="true">
        </div>
    </div>
    <div class="row mb-3">
      <label for="lastName" class="col-md-4 col-form-label text-md-end">{{ __('Prenom') }} : </label>
      <div class="col-md-6">
          <input id="lastName" type="text" class="form-control" name="lastName" value="{{ $user->lastName }}" autofocus readonly="true">
      </div>
    </div>
