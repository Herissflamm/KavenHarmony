    ...
    <nav class="bg-black-50 border-gray-200">
        ...
        <div class="flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            @auth
                ...
                <li>
                    <div class="rounded-full block text-purple-400 bg-white flex justify-center items-center p-1">
                        <a href="{{ url('/myBasket') }}">
                            <div class="relative">
                    ...
                    <div class="rounded-full block bg-white flex justify-center items-center">
                        <a href="{{ url('/account') }}" >
                            <div class="relative w-8 h-8 overflow-hidden bg-white rounded-full">
                                <svg class="absolute w-10 h-10 text-yellow-400 -left-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
                            </div>
                        </a>
                    </div>
                </li>                
